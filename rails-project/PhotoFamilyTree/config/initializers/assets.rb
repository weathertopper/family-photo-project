...
Rails.application.config.assets.precompile += %w( event_form.scss.css )
Rails.application.config.assets.precompile += %w( home.scss.css )
Rails.application.config.assets.precompile += %w( event_tag_form.scss.css )
Rails.application.config.assets.precompile += %w( memory_form.scss.css )
Rails.application.config.assets.precompile += %w( marriage_form.scss.css )
Rails.application.config.assets.precompile += %w( descendant_form.scss.css )
Rails.application.config.assets.precompile += %w( relative_form.scss.css )
Rails.application.config.assets.precompile += %w( photo_form.scss.css )
Rails.application.config.assets.precompile += %w( photo_tag_form.scss.css )
